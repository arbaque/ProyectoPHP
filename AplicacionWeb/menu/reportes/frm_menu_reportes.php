...
$menu_paciente="";
$menu_doctor="";
$menu_reportes="class='active open'";
$menu_seguridad="";
				...
				<div class="main-navigation navbar-collapse collapse">
					...
					<ul class="main-navigation-menu">
                        ...
                        <li <?php echo $menu_doctor; ?>>
							<a href="../doctor/frm_menu_doctor.php"><i class="fa fa-user-md"></i>
                        ...
                        <li <?php echo $menu_reportes; ?>>
							<a href="frm_menu_reportes.php"><i class="fa fa-clipboard"></i>
                ...
                <div class="menu_content">                        		
                      <div class="row">
                          <div class="col-md-12">
                                    ...
                                    <a href="../../modulos/reportes/paginas/frm_rep_consultas_medicas.php">
                                            	<div class="icono">                                                    
                         						<img src="../../img/icono_menu/reportes/consultas_medicas.png" width="128" height="128"/>
                         						<div class="label_icono">CONSULTAS</div>
                                                </div>
                                    </a> 
                                    
                                    <a href="../../modulos/reportes/paginas/frm_rep_enfcronica.php">
                                            	<div class="icono">                                                    
                         						<img src="../../img/icono_menu/reportes/enfermedades_cronicas.png" width="128" height="128"/>
                         						<div class="label_icono">ENF. CRÓNICAS</div>
                                                </div>
                                    </a>
                                    <a href="../../modulos/reportes/paginas/frm_rep_morbilidad.php">
                                            	<div class="icono">                                                    
                         						<img src="../../img/icono_menu/reportes/morbilidad.png" width="128" height="128"/>
                         						<div class="label_icono">MORBILIDAD</div>
                                                </div>
                                    </a> 
                                     
                                    <a href="../../modulos/reportes/paginas/frm_rep_vulnerabilidad.php">
                                            	<div class="icono">                                                    
                         						<img src="../../img/icono_menu/reportes/vulnerabilidad.png" width="128" height="128"/>
                         						<div class="label_icono">VULNERABILIDAD</div>
                                                </div>
                                    </a>                                   
                          </div>
                      </div>
