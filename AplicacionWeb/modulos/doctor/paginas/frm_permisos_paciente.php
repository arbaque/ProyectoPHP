...
require_once('../clases_datos/cls_permiso_datos.php');

$obj_met = new Metodos_comunes;
$obj_cls = new Permiso_datos;
								...
								<div class="panel-body buttons-widget">
                               		<div class="row">
                                    	<div class="col-md-12">
                                              ...
                                              <div class="row">
                                              	<div class="col-md-12">
                                                                        <div class="errorHandler1 alert alert-danger no-display">
                                                                            
<i class="fa fa-times-sign"></i><div id="mensaje_error1">Ud tiene algunos errores de ingreso. Por Favor verificar.</div>
                                                                        </div>
<div class="successHandler1 alert alert-success no-display">
<i class="fa fa-ok"></i><div id="mensaje_correcto">Permiso Agregado!</div>
                                                                        </div>
                                                                    </div>
                                              	<div class="col-md-12">
                                                	<div class="row">
										...
										<input id="txt_fecha" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" name="fecha_entrada" class="form-control date-picker"  readonly>
										<span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
                                                  	...
                                                  	<div class="form-group">    
                                                                             <label class="control-label">
                                                                                Tipo Permiso: <span class="symbol required"></span>
                                                                            </label>
                                                <select id="cbx_tipo_permiso" name="combo" class="form-control search-select">
                                                 <option value='0' selected="selected" >Selecciona una Opción</option>
                                                     <?php 
             $combo = $obj_met->MET_llena_combo("adm_tipo_permiso", "id", "descripcion", "","descripcion");
                                        echo $combo;
                                  ?>
                                                                            </select>
                                                                        </div>
                                                      ...
                                                      <div class="form-group">
                                           							<label for="form-field-mask-2">
                                                       					Motivo Permiso: <span class="symbol required">
                                                    				</label>
                                    							<textarea name="motivo" id="txt_permiso" rows="5" data-original-title="Motivo" class="form-control tooltips"></textarea>
                                    							</div>
          ...
          <button aria-hidden="true" data-dismiss="modal" class="btn btn-default" onClick="limpiar_form_permiso();">
                                                                            Cancelar
                                                                        </button>
      <button class="btn btn-default" type="button" onClick="Agregar_Permiso()">
						...
						<div class="col-sm-12">
							<div class="tabbable">
								...
								<div class="tab-content">
									...
									<div id="panel_datos_paciente" class="tab-pane in active">
                                    	<div class="panel panel-default">
...
<input type="text" id="txt_telefono_2" class="form-control input-mask-celphone" name="txt_telefono_2">
								...
								<div class="panel-body">
									<div class="space12">
                                        ...
                                        <div class="form-group">
											...
											<a data-toggle="modal" class="btn btn-info" role="button" href="#myModal1" onClick="limpiar_form_permiso()"><i class="clip-user-5"></i>
                                                Agregar
                                            </a>
                                                                </div>
                                                            </div>
                                    	...
                                    	<div class="table-responsive" id="grid_detalle_permiso">
                                            <table class="table table-striped table-hover" id="sample-table-2">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width:220px">Tipo Permiso</th>
	...
	<script src="../../../assets/js/main.js"></script>
		...
		<script src="../../../assets/js/consulta_permisos.js"></script>  
 		 <script type="text/javascript" src="../js/ajax_permisos.js"></script>		
		<!-- InstanceEndEditable -->
	...
	<script>
			...
			if(id_paciente!==0){
				...
				carga_grid_detalle_ajax(id_paciente);		
			}
