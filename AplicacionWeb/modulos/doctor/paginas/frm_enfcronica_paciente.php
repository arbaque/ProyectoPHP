...
require_once('../clases_datos/cls_enfcronica_datos.php');

$obj_met = new Metodos_comunes;
$obj_cls = new Enfcronica_datos;
...
<input type="text" id="txt_telefono_2" class="form-control input-mask-celphone" name="txt_telefono_2">
	...
	<script src="../../../assets/js/main.js"></script>
		...
		<script src="../../../assets/js/consulta_permisos.js"></script>  
 		 <script type="text/javascript" src="../js/ajax_enfcronica.js"></script>	
		<!-- InstanceEndEditable -->
