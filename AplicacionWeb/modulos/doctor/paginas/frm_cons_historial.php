						...
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-body">
                                    ...
                                    <form action="frm_crear_consulta.php" role="form" id="form" method="post">
                                    <input id="txt_id_consulta" name="txt_id_consulta" type="hidden" value="">
									<div class="table-responsive" id="grid">
										    	<?php 
	  												$grid = $obj_cls->MET_llenaGrid();
													echo $grid;
	  											?>											
									</div>
                                    </form>
...
<script type="text/javascript" src="../../../assets/plugins/select2/select2.min.js"></script>
        ...
        <script type="text/javascript" src="../js/ajas_historial.js"></script>	
		<!-- InstanceEndEditable -->
