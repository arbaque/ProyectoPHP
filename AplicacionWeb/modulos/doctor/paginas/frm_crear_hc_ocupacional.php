		...
		<div class="main-container">
			...
			<div class="main-content">
				...
				<!-- InstanceBeginEditable name="contenido" -->
                    ...
                    <!-- start: Modal Antecedentes Laborales -->
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                <h2><i class="fa fa-pencil-square teal"></i> Registro de Antecedentes Laborales </h2>
...
<i class="fa fa-times-sign"></i><div id="mensaje_error">Ud tiene algunos errores de ingreso. Por Favor verificar.</div>
                                                            </div>
<div class="successHandler alert alert-success no-display">
<i class="fa fa-ok"></i><div id="mensaje_correcto">Formulario Validado con Éxito!!</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="txt_antc_empresa" name="txt_antc_empresa">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label">
                                                                    Tiempo:
                                                                </label>
                                                                <input type="text" class="form-control" id="txt_antc_tiempo" name="txt_antc_tiempo">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="txt_antc_cargo" name="txt_antc_cargo">
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select multiple="multiple" id="cbx_tipo_riesgo" class="form-control search-select">
                                                                    <?php 
																			$combo = $obj_met->MET_llena_combo("adm_tipo_riesgo", "id", "descripcion", "","descripcion");
																			echo $combo;
																	  ?>
                                                                </select>
                                                            </div> 
                                                    ...
                                                    <div class="row">
                                                        <div class="modal-footer">
                                                            <button aria-hidden="true" data-dismiss="modal" class="btn btn-default" onClick="limpiar_form();">
                                                                Cancelar
                                                            </button>
<button class="btn btn-default" type="submit">
  Guardar<i class="fa fa-arrow-circle-right"></i>
                    ...
                    <!-- end: Modal Antecedentes Laborales -->
                    
                    <!-- start: Modal Dependientes -->
                    <div class="modal fade" id="myModalDependientes" role="dialog" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <!-- start: PAGE CONTENT -->
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                <h2><i class="fa fa-pencil-square teal"></i> Registro de Dependientes </h2>
...
<i class="fa fa-ok"></i><div id="mensaje_correcto">Formulario Validado con Éxito!!</div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="txt_nombre_dependiente" name="txt_nombre_dependiente">
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label">
                                                                    Apellido:
                                                                </label>
                                                                <input type="text" class="form-control" id="txt_apellido_dependiente" name="txt_apellido_dependiente">
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="input-group">
                                                                    <input id="txt_fecha_nac_dependiente" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" name="txt_fecha_nac_dependiente" class="form-control date-picker" readonly onChange="calcula_edad(this.value)">
                                                                ...
                                                                <input type="text" class="form-control" id="txt_edad_dependiente" name="edad" disabled>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                           ...
                                                           <div class="form-group">
                                                                ...
                                                                <select id="cbx_genero_dependiente" name="combo" class="form-control search-select">
                              ...
                              ?>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select id="cbx_parentesco" name="combo" class="form-control search-select">
                                                                         <option value='0' selected="selected" >Selecciona una Opción</option>
                                                                                                        <?php 
                                    $combo = $obj_met->MET_llena_combo("adm_parentesco", "id", "descripcion", "","descripcion");
                                    echo $combo;
                              ?>
                                                                    </select>
                                                            </div>
						...
						<div class="col-sm-12">
							<div class="tabbable">
								<ul class="nav nav-tabs tab-padding tab-space-3 tab-blue" id="myTab4">
                                    ...
                                    <li>
										<a data-toggle="tab" href="#panel_datos_pct_dependientes">
											Dependientes
										</a>
									</li>
									<li>
										<a data-toggle="tab" href="#panel_antecedentes_laborales">
											Antec. Laboral
										</a>
									</li>
                                    <li>
										<a data-toggle="tab" href="#panel_antecedentes_app">
											APP
										</a>
									</li>
                                    <li>
										<a data-toggle="tab" href="#panel_antecedentes_apf">
											APF
										</a>
									</li>
                                    <li>
										<a data-toggle="tab" href="#panel_antecedentes_inmunizaciones">
											Inmunizaciones
										</a>
									</li>
                                    <li>
										<a data-toggle="tab" href="#panel_antecedentes_sg_vitales">
											Sv
										</a>
									</li>
                                    <!--<li>
										<a data-toggle="tab" href="#panel_antecedentes_examenes">
											Exámenes
										</a>
									</li>
                                    <li>
										<a data-toggle="tab" href="#panel_antecedentes_prescipcion">
											Rp
										</a>
									</li>-->
								</ul>
            												...
            												<div class="col-md-12">
                                           						<div class="form-group">
                                           							<label for="form-field-mask-2">
                                                       					Diagnóstico: <span class="symbol required">
                                                    				</label>
                                    							<textarea name="diagnostico" id="txt_diagnostico" rows="5" data-original-title="Diagnostico" class="form-control tooltips"></textarea>
                                    							</div>
                                                			</div>
                                                        </div>
...
<input type="text" id="txt_telefono_2" class="form-control input-mask-celphone" name="txt_telefono_2">
      ...
      ?>
					...
					<input type="checkbox" value="" name="chk_4" class="grey" id="chk_afiliado">
                                     ...
                                     <div id="panel_datos_pct_dependientes" class="tab-pane">
                                    	<div class="panel panel-default">
											<div class="panel-body">
												<div class="space12">
                                    	            <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                             <label class="control-label">
                                                                               &nbsp;
                                                                                ...
                                                                                <a data-toggle="modal" class="btn btn-info" role="button" href="#myModalDependientes"><i class="clip-user-5"></i>
                                                                                    Agregar
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div id="panel_antecedentes_laborales" class="tab-pane">
                                    	<div class="panel panel-default">
											<div class="panel-body">
												<div class="space12">
                                    	            <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                             <label class="control-label">
                                                                               &nbsp;
                                                                                ...
                                                                                <a data-toggle="modal" class="btn btn-info" role="button" href="#myModal2"><i class="clip-user-5"></i>
                                                                                    Agregar
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                     ...
                                     <div id="panel_antecedentes_app" class="tab-pane">
                                    	<div class="panel panel-default">
											<div class="panel-body">
												<div class="space12">
                                    	            <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_antc_clinicos" name="txt_antc_clinicos">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                        Quirúrgicos:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="txt_antc_quirurgicos" name="txt_antc_quirurgicos">
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_antc_hospitalizacion" name="txt_antc_hospitalizacion">
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_antc_alergias" name="txt_antc_alergias">
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_antc_fisico" name="txt_antc_fisico">
                                                                </div>
                                     ...
                                     <div id="panel_antecedentes_apf" class="tab-pane">
                                    	<div class="panel panel-default">
											<div class="panel-body">
												<div class="space12">
                                    	            <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_antc_apf_padre" name="txt_antc_apf_padre">
                                                                </div>
                                                         </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_antc_apf_madre" name="txt_antc_apf_madre">
                                                                </div>
                                     ...
                                     <div id="panel_antecedentes_inmunizaciones" class="tab-pane">
                                    	<div class="panel panel-default">
											<div class="panel-body">
												<div class="space12">
                                    	            <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">   
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_antc_inm_fiebre_amarilla" name="txt_antc_inm_fiebre_amarilla">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                        Tétanos:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="txt_antc_inm_tetanos" name="txt_antc_inm_tetanos">
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_antc_inm_otras" name="txt_antc_inm_otras">
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_antc_inm_hepatitis" name="txt_antc_inm_hepatitis">
                                                                </div> 
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_antc_inm_tifoidea" name="txt_antc_inm_tifoidea">
                                                                </div>
                                     ...
                                     <div id="panel_antecedentes_sg_vitales" class="tab-pane">
                                    	<div class="panel panel-default">
											<div class="panel-body">
                                            	<h2><i class="fa fa-pencil-square teal"></i> Signos Vitales </h2>
												<div class="space12">
                                    	            <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_sv_pa" name="txt_sv_pa">
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_sv_fr" name="txt_sv_fr">
                                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="txt_sv_fc" name="txt_sv_fc">
                                                            </div>                    
                                                        </div>
                                                     </div>
                                                    </div>
                                                    <h2><i class="fa fa-pencil-square teal"></i> Talla </h2>
                                                    <div class="form-group">
                                                        <div class="row">
                                                        	<div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_sv_talla" name="txt_sv_talla">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                        IMC:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="txt_sv_imc" name="txt_sv_imc">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_sv_peso" name="txt_sv_peso">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                         TEMP:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="txt_sv_temp" name="txt_sv_temp">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <h2><i class="fa fa-pencil-square teal"></i> Somático General </h2>
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                	<div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" id="txt_sg_apariencia" name="txt_sg_apariencia">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label">
                                                                            ESTADO NUTRICIONAL:
                                                                        </label>
                                                                        <input type="text" class="form-control" id="txt_sg_estado_nutricional" name="txt_sg_estado_nutricional">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_sg_act_psicometrica" name="txt_sg_act_psicometrica">
                                                                </div>
                                                            </div>
                                                            </div>
                                                        </div>    
                                                        <h2><i class="fa fa-pencil-square teal"></i> Somático Regional </h2>
                                                        <div class="form-group">
                                                        <div class="row">
                                                        	<div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_sr_piel_tegumento" name="txt_sr_piel_tegumento">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                        CABEZA Y CUELLO:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="txt_sr_cabeza_cuello" name="txt_sr_cabeza_cuello">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                        TÓRAX:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="txt_sr_torax" name="txt_sr_torax">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                        CORAZÓN:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="txt_sr_corazon" name="txt_sr_corazon">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                        PULMONES:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="txt_sr_pulmon" name="txt_sr_pulmon">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="txt_sr_abdomen" name="txt_sr_abdomen">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                        REGIÓN LUMBAR:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="txt_sr_region_lumbar" name="txt_sr_region_lumbar">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                        EXTREMIDADES:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="txt_sr_extremidad" name="txt_sr_extremidad">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">
                                                                        NEUROLÓGICO ELEMENTAL:
                                                                    </label>
                                                                    <input type="text" class="form-control" id="txt_sr_neuro_elemental" name="txt_sr_neuro_elemental">
                                                                </div>
                                                            </div>
                                                        </div>
                                                      </div>   
